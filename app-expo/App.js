...
import { StyleSheet, View, Text, TouchableOpacity, ActivityIndicator, Platform, StatusBar, Animated } from 'react-native';
...
function MainAppShell() {
  const { isInitialized, currentUserPhone } = useContext(AppDataContext);
      ...
      case 3:
        return (
          <ProfileScreen 
            ...
            onGoToChangePassword={() => setShowChangePassword(true)}
