...
export default function ProfileScreen({ 
  ...
  const { currentUserName, currentUserEmail, logoutUser, updateUserName } = useContext(AppDataContext);
        ...
        <View style={styles.profileCard}>
          <View style={styles.avatar}>
            <Text style={styles.avatarText}>
              {currentUserName ? currentUserName.substring(0, 2).toUpperCase() : 'GP'}
            </Text>
          </View>
          <View style={styles.details}>
            ...
            <Text style={styles.phone}>{currentUserEmail || 'guest@gomatka.com'}</Text>
          </View>
        </View>
