...
export default function PlayLoader({ visible }) {
  ...
  const htmlContent = `
    ...
    <head>
      ...
      <style>
        ...
        .loader {
          --main-size: 48vw; /* 200% More */
          --text-color: ${Colors.textPrimary};
          --shine-color: ${Colors.border};
  ...
  if (Platform.OS === 'web') {
    return (
      <View style={styles.container}>
        <iframe
          srcDoc={htmlContent}
          style={{ width: '100%', height: '100%', border: 'none', backgroundColor: Colors.background }}
          title="play-loader"
        />
      </View>
    );
